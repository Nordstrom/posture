...
const warnings = {
  'length-10-75_root_paths_PATH_OPERATION_summary': (line) => warn(`line ${line} - Summary field for '$OPERATION $PATH' should be a short name - about 50 characters. eg: Get user by name`),
  'length-25-10000_root_paths_PATH_OPERATION_description': (line) => warn(`line ${line} - Description field for '$OPERATION $PATH' should be more descriptive.`),
